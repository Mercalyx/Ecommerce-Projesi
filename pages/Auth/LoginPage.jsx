  ...
  return (
    <main className="max-w-md mx-auto px-4 py-16 sm:px-6">
      <div className="text-center mb-8">
        <h1 className="font-display text-3xl font-semibold text-brand-950 dark:text-white">Tekrar Hoş Geldiniz</h1>
        <p className="mt-2 text-sm text-brand-700 dark:text-brand-300">Hesabınıza giriş yapın ve alışverişe devam edin.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-brand-900 border border-brand-100 dark:border-brand-800 rounded-2xl shadow-card p-6 sm:p-8 space-y-5">
        ...
        <p className="text-center text-sm text-brand-600 dark:text-brand-300">
          Hesabınız yok mu?{" "}
          <Link to="/kayit" className="font-medium text-brand-900 dark:text-brand-200 hover:underline">
            Kayıt olun
          </Link>
        </p>
      </form>
